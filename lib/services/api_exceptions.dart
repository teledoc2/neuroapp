...
class ClientException extends ApiException {
  ClientException(String message, {int? code}) : super(message, code: code);
}

class AuthenticationException extends ApiException {
  AuthenticationException(String message, {int? code}) : super(message, code: code);
}

class ValidationException extends ApiException {
  final Map<String, dynamic>? validationErrors;

  ValidationException(String message, {int? code, this.validationErrors})
